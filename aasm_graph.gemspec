...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ["Ashley Engelund", "Ivan Tse", "Esteban Pastorino"]
  spec.email         = ["ashley_engelund@gmail.com", "ivan.tse1@gmail.com", "ejpastorino@gmail.com"]
  ...
  spec.add_dependency "aasm", "~> 4.11", '>= 4.11'

  spec.add_development_dependency 'bundler', '~> 1.7', '>= 1.7'
